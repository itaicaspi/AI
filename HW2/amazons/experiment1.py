...
players_scores = dict()
players = ['simple_player', 'selective_alpha_beta_0_75', 'selective_alpha_beta_0_5', 'selective_alpha_beta_0_25', 'selective_alpha_beta_0_125']
f = open('exp1_res_k10.txt', 'w')
